<?php
    ...
    $email_to = 'Your Email';
    $headers = 'From NXT IPN Script';    $headers = 'From LTC IPN Script';
   ...
   */
   ...
   $email_message = 'An LTC deposit has been confirmed!   ';

   $email_message .= ' Ripple: '.clean_string($ripple).'   ';

   $email_message .= ' Currency1 '.clean_string($currency1).'  ';

   $email_message .= ' LTC Amount: '.clean_string(($amount1 - $SF)).'   ';
   ...
   $subject = "LTC IPN: Script Completed";
