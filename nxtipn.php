<?php
   ...
   */
   ...
   $email_message = 'An NXT deposit has been confirmed!   ';

   $email_message .= ' Ripple: '.clean_string($ripple).'   ';

   $email_message .= ' Currency1 '.clean_string($currency1).'  ';

   $email_message .= ' NXT Amount: '.clean_string(($amount1 - $SF)).'   ';
   ...
   $subject = "NXT IPN: Script Completed";
