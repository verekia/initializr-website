...
if(isset($_POST['email'])) {
    ...
    $XAGamount = $_POST['XXXamount'];
	
    $ripple = $_POST['ripple']; // required
  ...
  }elseif ($XXXamount >= 100){ //If you want to limit how much of an asset can be deposited in one transaction, include it here
		
		$error_message .= 'The amount you entered does not appear to be valid.  For orders larger than 100 XAG, <a href="mailto:YOUREMAIL@DOMAIN.COM">please send us an email</a>.<br />';
	}
	
	$serviceFee = $XXXamount * 0.02;
	
	$totalXXX = $XXXamount - $serviceFee;
  ...
  if(strlen($error_message) > 0) {
	...
	$email_message .= "Total: ".clean_string($totalXXX)."\n";
...
Return to <a href="index.php">homepage</a>.<br />
</body>
