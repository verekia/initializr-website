...
The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.</p>
	...
	<form name="withdraw" method="post" action="xw.php">
...
<table width="450px">
 ...
 <td valign="top">
  ...
  <input  type="text" name="FName" maxlength="53" size="40">
 ...
 <td valign="top">
  ...
  <input  type="text" name="XXXamount" maxlength="8" size="6">
 ...
 <td colspan="2" style="text-align:center">
  ...
  <input type="submit" value="Submit">
      ...
      <hr>
          ...
          <footer>
        <p>&copy; <?php include $_SERVER['DOCUMENT_ROOT']."/include.php"; echo $gatewayName; ?><?php include $_SERVER['DOCUMENT_ROOT']."/include.php"; echo $gatewayName; ?> 20XX ~~~ Please read our <a href="/tos.php">Terms of Service</a>.</p>
